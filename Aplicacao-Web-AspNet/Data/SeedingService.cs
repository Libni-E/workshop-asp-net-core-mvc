...
using System;
using Aplicacao_Web_AspNet.Models.Enums;

namespace Aplicacao_Web_AspNet.Data
{
    public class SeedingService
    {
        private Aplicacao_Web_AspNetContext _context;

        public SeedingService(Aplicacao_Web_AspNetContext context)
        {
            _context = context;
        }
        public void Seed()
        {
            ...
            {
                return; //O banco de dados ja foi polulado
            }
            ...
            Seller s1 = new Seller(1, "Bob Browm", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
